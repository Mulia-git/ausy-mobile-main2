...
import 'package:ausy/features/schedule/views/widgets/category_item.dart';
...
class _SchedulePageState extends State<SchedulePage> {
  ...
  initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      scheduleController.changeQuery('');
            ...
            children: [
                  ...
                  children: [
                    Expanded(
                      child: CustomTextBox(
                        ...
                        onSubmitted: (value) {
                          scheduleController.changeQuery(value);
                        },
                      ),
                    ),
                  ],
                    ...
                    children: List.generate(
                      ...
                      (index) => CategoryItem(
                        ...
                        isSelected: shifts[index] ==
                            scheduleController.selectedShift.value,
                        onTap: () {
                          setState(() {
                            scheduleController.changeShift(shifts[index]);
                          });
                        },
                      ),
                    ),
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Text(
                      formatTanggalIndo(
                          DateTime.parse(scheduleController.date.value)),
              ...
              Padding(
                ...
                child: scheduleController.isLoading.value
                    ...
                    : scheduleController.filteredSchedules.isNotEmpty
                        ? ListView.builder(
                            itemCount:
                                scheduleController.filteredSchedules.length,
                            physics: const NeverScrollableScrollPhysics(),
                            shrinkWrap: true,
                            itemBuilder: (context, index) {
                              final schedule =
                                  scheduleController.filteredSchedules[index];
